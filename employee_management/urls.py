...
urlpatterns = [
    ...
    path('', emp_views.home_redirect, name='home'),
    path('login/', emp_views.login_view, name='login'),
    path('logout/', emp_views.logout_view, name='logout'),
    path('dashboard/', emp_views.dashboard_view, name='dashboard'),
...
handler404 = 'employees.views.custom_404_view'
